...
app.post("/submit", (req, res) => {
  ...
  const randomAdjInd = Math.floor(Math.random() * adj.length);
  let randomAdj = adj[randomAdjInd];
  const randomNounInd = Math.floor(Math.random() * noun.length);
  let randomNoun = noun[randomNounInd]
